...
export const About = () => {
    return (
            <section className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover section--home container h-full m-auto absolute section opacity-0"
                >
                ...
                <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                    ...
                    <div className="w-full lg:w-2/5">
                        ...
                        <img height="80vh" alt="conference Andrew" src={aboutme} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block h-full"/>
