  ...
  return (
    <div>
      <h2 className='
                  ...
                  my-5
                  '>CERTIFICATIONS</h2>
      <div className="flex items-center space-x-2 mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
        {certificates.map(certificate => (
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="relative group bg-gray-900 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
              <img class="object-cover object-center" src={certificate.img} alt="cuisine" />
